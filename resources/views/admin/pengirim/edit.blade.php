...
@section('title', 'Edit Pengirim - Admin')
            ...
            <div
                ...
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 bg-white rounded-t-2xl">
                        <h6 class="text-base font-semibold leading-7 text-gray-900">Edit Pengirim</h6>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="name" id="name" autocomplete="name"
                                            ...
                                            @error('name') is-invalid @enderror value="{{ $pengirim->name }}">
                                        @error('name')
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="email" name="email" id="email" autocomplete="email"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            @error('email') is-invalid @enderror value="{{ $pengirim->email }}">
                                        @error('email')
                                            <div class="mt-1 text-sm font-semibold text-red-600">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <input type="text" name="phone" id="phone" autocomplete="phone"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            @error('phone') is-invalid @enderror value="{{ $pengirim->phone }}">
                                        @error('phone')
                                            <div class="mt-1 text-sm font-semibold text-red-600">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="sm:col-span-3">
                                    ...
                                    <div class="mt-2">
                                        <textarea id="address" name="address" rows="2"
                                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            @error('address') is-invalid @enderror>{{ $pengirim->address }}</textarea>
                                    </div>
                                    @error('address')
                                        <div class="mt-1 text-sm font-semibold text-red-600">{{ $message }}</div>
                                    @enderror
